...
export default function ResidentAI(){
  ...
  const send = async()=>{
    ...
    const res = await fetch("/api/resident-ai",{
      method:"POST",
  ...
  return(
    <>
      ...
      <div
        ...
        className="fixed bottom-6 right-6 bg-purple-600 text-white px-5 py-3 rounded-full cursor-pointer shadow-lg"
      >
        🤖 AI
      </div>
